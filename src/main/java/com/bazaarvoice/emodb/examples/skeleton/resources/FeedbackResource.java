...
public class FeedbackResource {
    ...
    public Response getFeedback(@PathParam("feedbackid") String feedbackID) {
        createTableIfNonExistant();
        return Response.ok(
                    sorClient.get(TABLE, feedbackID, ReadConsistency.WEAK),
    ...
    public Response deleteUser(@PathParam("userid") String userID) {
        ...
        sorClient.update(
                ...
                TimeUUIDs.newUUID(),
                Deltas.delete(),
                new AuditBuilder().setLocalHost().setProgram(WellKnowns.APP_NAME).setComment("Deleting user").build(),
                WriteConsistency.STRONG);
        return Response.ok().build();
    }
